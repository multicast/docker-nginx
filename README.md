...
The [NGINX](https://packages.debian.org/buster/nginx) package from [Debian](https://debian.org/)
[Buster](https://wiki.debian.org/DebianBuster) using
[systemd](https://hub.docker.com/r/mkovac/systemd-buster/)-enabled
base image
...
# Packages
    ...
    ii  libnginx-mod-http-auth-pam            1.14.2-2+deb10u1            amd64        PAM authentication module for Nginx
    ii  libnginx-mod-http-echo                1.14.2-2+deb10u1            amd64        Bring echo and more shell style goodies to Nginx
    ii  libnginx-mod-http-fancyindex          1.14.2-2+deb10u1            amd64        Fancy indexes module for the Nginx
    ii  libnginx-mod-http-headers-more-filter 1.14.2-2+deb10u1            amd64        Set and clear input and output headers for Nginx
    ii  libnginx-mod-http-upstream-fair       1.14.2-2+deb10u1            amd64        Nginx Upstream Fair Proxy Load Balancer
    ...
    ii  nginx-light                           1.14.2-2+deb10u1            amd64        nginx web/proxy server (basic version)
